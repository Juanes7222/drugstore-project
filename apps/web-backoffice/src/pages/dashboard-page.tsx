...
export function DashboardPage() {
  ...
  const dangerTone = (active: boolean): KpiTone => (active ? 'error' : 'default');
      ...
      <Grid container spacing={2} mb={3}>
        <Grid item xs={12} sm={6} md={4} lg={3}>
          <KpiCard
            ...
            subtitle={t('dashboard.salesTodaySub', { count: sales.confirmedCount })}
        ...
        <Grid item xs={12} sm={6} md={4} lg={3}>
          <KpiCard
            ...
            subtitle={t('dashboard.annulledTodaySub', { count: sales.annulledCount })}
            icon={CancelIcon}
