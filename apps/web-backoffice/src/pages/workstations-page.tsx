...
export function WorkstationsPage() {
        ...
        cell: (info) => {
          ...
          return (
            <Chip
              ...
              variant="outlined"
              label={active ? t('workstations.online') : t('workstations.offline')}
            />
          );
        },
      },
  ...
  return (
    <Box>
      <PageHeader title={t('workstations.title')} subtitle={t('workstations.subtitle')} />

      <Paper variant="outlined" sx={{ p: 2, mb: 3 }}>
        <Typography variant="subtitle2" fontWeight={700}>
          {t('workstations.activeSessionCount')}:{' '}
          <Typography component="span" variant="subtitle1" fontWeight={700} color="primary">
