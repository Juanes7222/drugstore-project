...
export function PlanDocument({
  ...
  // Hook at the top level (Rules of Hooks): the “≈ al mes” line rolls too,
  // even though it only renders for non-monthly periods.
        ...
        <table className="mt-5 w-full text-sm">
          ...
          <tbody className="divide-y divide-tinta/10">
            <tr>
              <th
                scope="row"
                className="py-2.5 pr-4 text-left font-normal text-tinta-media"
              >
                {t("pricing.row_license")}
              </th>
              <td className="data py-2.5 text-right">
                {t("pricing.value_license", {
                  amount: formatCOP(plan.basePriceCents),
                })}
              </td>
            </tr>
            <tr>
