    ...
    >
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <Reveal>
          <h2
            id="pillars-title"
            className="display max-w-2xl text-3xl font-bold sm:text-4xl"
          >
            {t("pillars.title")}
          </h2>
        </Reveal>
            ...
            return (
              <li key={item.title} className="max-w-md">
                <Reveal index={index % 2} className="h-full">
                  <div className="card-lift h-full rounded-xl border border-tinta/15 bg-white p-6">
                    ...
                    {item.detail ? (
                      <p className="data mt-4 border-t border-tinta/10 pt-3 text-xs text-verde-cruz-oscuro">
                        {item.detail}
                      </p>
                    ) : null}
                  </div>
