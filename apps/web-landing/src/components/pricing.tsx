...
export function Pricing() {
  ...
  return (
    <section
      ...
      className="scroll-mt-16 bg-menta py-20 lg:py-28"
    >
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <Reveal index={1}>
          <fieldset className="mt-10">
            <legend className="eyebrow text-tinta-media">
        ...
        {/* Price provenance — announced politely when the live swap lands.
            The green dot pulses: prices are verified live. */}
        <p
          role="status"
        ...
        <Reveal className="mx-auto mt-14 max-w-2xl">
          <div className="space-y-2 text-center text-sm text-tinta-media">
