...
export function OfflinePanel() {
  ...
  const queueLines = t("offline.queue_items", {
    returnObjects: true,
  }) as string[];
  ...
  return (
    <section
      ...
      className="bg-papel py-20 lg:py-24"
    >
              ...
              <ul aria-hidden="true" className="data mt-4 space-y-3 text-sm">
                {queueLines.map((line, index) => {
                  ...
                  return (
                    ...
                    >
                      <span className="data min-w-0 truncate text-papel/85">
                        {line}
                      </span>
                      {sent ? (
                        ...
                        <span className="flex shrink-0 items-center gap-1.5 rounded-full bg-menta/15 px-2 py-0.5 text-[11px] font-medium text-menta">
                          <span className="pulse-dot inline-block size-1.5 rounded-full bg-menta text-menta" />
