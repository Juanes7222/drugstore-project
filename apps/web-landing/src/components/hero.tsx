...
export function Hero() {
  ...
  return (
    <section id="inicio" className="relative overflow-hidden">
      {/* Ambient pharmacy-green field behind both columns; never interactive. */}
      <div className="hero-ambient" aria-hidden="true" />
      <PlusIcon
        aria-hidden="true"
        className="hero-plus absolute top-14 right-4 hidden lg:block"
      />

      <div className="relative mx-auto grid max-w-6xl items-center gap-12 px-4 pt-16 pb-20 sm:px-6 lg:grid-cols-[1.02fr_0.98fr] lg:pt-24 lg:pb-28">
        <div>
          <p
            className="eyebrow rise-in text-verde-cruz"
