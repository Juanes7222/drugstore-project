...
export function CtaBand() {
  ...
  return (
    <section
      ...
      className="bg-verde-cruz py-20 lg:py-24"
    >
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <article
          ...
          style={
            { "--perforation-bg": "var(--color-verde-cruz)" } as CSSProperties
          }
        >
          {/* Receipt header */}
          ...
          <dl className="space-y-2 pt-3 text-sm">
            <div className="flex items-baseline justify-between gap-4">
              <dt className="text-tinta-media">
                {t("cta_band.doc_line_sedes")}
              </dt>
              <dd className="data shrink-0">✓</dd>
            </div>
            <div className="flex items-baseline justify-between gap-4">
              <dt className="text-tinta-media">
                {t("cta_band.doc_line_features")}
              </dt>
              <dd className="data shrink-0">✓</dd>
            </div>
            <div className="flex items-baseline justify-between gap-4">
