/**
 * Colombia territorial division (DIVIPOLA) - static reference data.
 *
 * 33 territorial entities (32 departments plus Bogota D.C.)
 * and 1123 municipalities with their official DANE codes. The list is
 * fixed by law, so it ships embedded for offline-first operation instead of
 * being fetched. Values persisted on records are the display names.
 */

export interface ColombiaMunicipality {
  /** Official DANE code, e.g. "05001". */
  code: string;
  /** Display name, e.g. "Medellin" (with accents). Persisted on records. */
  name: string;
}

export interface ColombiaDepartment {
  /** Official DANE code, e.g. "05". */
  code: string;
  name: string;
  municipalities: readonly ColombiaMunicipality[];
}
...
export const COLOMBIA_DEPARTMENTS: readonly ColombiaDepartment[] = [
  ...
  },
  {
    ...
    municipalities: [
      ...
      { code: "05664", name: "San Pedro" },
      { code: "05665", name: "San Pedro de Uraba" },
      ...
      { code: "05042", name: "Santafé de Antioquia" },
  ...
  },
  {
    ...
    municipalities: [
      ...
      { code: "13670", name: "San Pablo de Borbur" },
  ...
  },
  {
    ...
    municipalities: [
      ...
      { code: "18094", name: "Belén de los Andaquies" },
  ...
  },
  {
    ...
    municipalities: [
      ...
      { code: "85325", name: "San Luis de Gaceno" },
  ...
  },
  {
    ...
    municipalities: [
      ...
      { code: "27025", name: "Alto Baudo" },
      { code: "27050", name: "Atrato" },
      { code: "27073", name: "Bagadó" },
      { code: "27075", name: "Bahía Solano" },
      { code: "27077", name: "Bajo Baudó" },
      { code: "27086", name: "Belén de Bajira" },
      { code: "27099", name: "Bojaya" },
      { code: "27150", name: "Carmen del Darien" },
  ...
  },
  {
    ...
    municipalities: [
      ...
      { code: "23670", name: "San Andrés Sotavento" },
  ...
  },
  {
    ...
    municipalities: [
      ...
      { code: "25843", name: "Villa de San Diego de Ubate" },
  ...
  },
  {
    ...
    municipalities: [
      ...
      { code: "47570", name: "Pueblo Viejo" },
      { code: "47605", name: "Remolino" },
      { code: "47660", name: "Sabanas de San Angel" },
  ...
  },
  {
    ...
    municipalities: [
      ...
      { code: "86865", name: "Valle de Guamez" },
  ...
  },
  {
    ...
    municipalities: [
      ...
      { code: "73148", name: "Carmen de Apicala" },
...
/** Look up a department entity by its persisted display name. */
export function findDepartmentByName(name: string): ColombiaDepartment | undefined {
  const normalized = name.trim().toLocaleLowerCase("es-CO");
  return COLOMBIA_DEPARTMENTS.find(
    (department) => department.name.toLocaleLowerCase("es-CO") === normalized,
  );
}
