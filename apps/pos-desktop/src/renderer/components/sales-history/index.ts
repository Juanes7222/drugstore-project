export { SalesHistoryList } from './sales-history-list';
export type { SalesHistoryListProps } from './sales-history-list';

export { SalesHistoryDetail } from './sales-history-detail';
export type { SalesHistoryDetailProps } from './sales-history-detail';
