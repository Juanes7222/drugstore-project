/**
 * Unit tests for SyncRecoveryService — retry operation.
 *
 * Discard actions were removed by product decision: discarding queued
 * business movements creates unrecoverable holes in the per-workstation
 * movement sequence, so no user-facing flow may set DISCARDED anymore.
 */
