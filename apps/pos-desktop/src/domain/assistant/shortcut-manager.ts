...
const DEFAULT_BINDINGS: ShortcutBinding[] = [
  ...
  { id: "shortcut.select-line", key: "↑/↓", commandId: "cmd.select-cart-line", context: "SALE_FLOW", description: "Seleccionar línea (carrito / método de pago)" },
  { id: "shortcut.payment-amount", key: "0-9", commandId: "cmd.payment-amount", context: "SALE_FLOW", description: "Digitar monto del método de pago" },
  { id: "shortcut.payment-add-method", key: "+", commandId: "cmd.payment-add-method", context: "SALE_FLOW", description: "Agregar método de pago" },
  { id: "shortcut.payment-authorize", key: "Enter", commandId: "cmd.payment-authorize", context: "SALE_FLOW", description: "Autorizar método electrónico" },
