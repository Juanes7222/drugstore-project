...
export const CreatePurchaseReceptionItemSchema = z.object({
  ...
  purchaseOrderItemId: z.uuid("Invalid purchase order item ID").optional(),
  ...
  taxSchemeId: z.uuid("Invalid tax scheme ID"),
...
export const CreatePurchaseReceptionSchema = z.object({
  ...
  purchaseOrderId: z.uuid("Invalid purchase order ID").optional(),
